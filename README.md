...
## 💡 느낀점
### 김동인
- 팀 프로젝트를 진행하면서 가장 크게 느낀점은 프로젝트 초반에 요구사항, 디자인, API, ERD 등의 프로젝트 전반적인 기초를 단단히 잡고 시작해야 한다는 점이었습니다.  이번 프로젝트는 기획이 충분히 되지 않은 상태로 기능 개발을 시작해서 프로젝트 중간에 헤메고 다시 요구사항을 정리하며 시간을 많이 낭비한 것 같습니다.  다음 프로젝트는 기획단계에서 충분한 시간을 가지고 프로젝트 기초를 더 탄탄하게 다지고 개발에 들어가야 한다는 것을 배웠습니다.
