...
### 김병규
- 팀 프로젝트는 개인 프로젝트와 많은 부분에서 다르다는 것을 크게 느꼈다. 기초 기반 틀을 다져가면서 타 팀을 보면서 내심 불안감에 휘둘려서 DB, 기초가 되는 디자인들을
  확실하게 지정하고 진행을 했어야 했는데 분위기에 휩쓸려 마무리 못 짓고 작업을 시작해서 프로젝트 기간동안 게속 수정 및 반영을 프로젝트 작업을 하면서 해버려서
